...
axs1[0].plot(t,x_nonlinear[:,0], label="True")
axs1[1].plot(t,x_estimated[:,1], label="linearized")
axs1[1].plot(t,x_nonlinear[:,1], label="True")
axs1[2].plot(t,theta_g_bounded, label="linearized")
axs1[2].plot(t,x_nonlinear[:,2], label="True")
axs1[3].plot(t,x_estimated[:,3], label="linearized")
axs1[3].plot(t,x_nonlinear[:,3], label="True")
axs1[4].plot(t,x_estimated[:,4], label="linearized")
axs1[4].plot(t,x_nonlinear[:,4], label="True")
axs1[5].plot(t,theta_a_bounded, label="linearized")
axs1[5].plot(t,x_nonlinear[:,5], label="True")
fig1.suptitle("Linearized States Vs Nonlinear")
